...
class DropColumnTest extends AuditCommandTestCase
{
  ...
  public function test01(): void
  {
    ...
    // Drop column c3.
    AuditDataLayer::$dl->executeMulti(file_get_contents(__DIR__.'/config/drop_column.sql'));
    ...
    // Test triggers.
    AuditDataLayer::$dl->executeNone('insert into `TABLE1`(c1, c2, c4) values(1, 2, 4)');
    AuditDataLayer::$dl->executeNone('update `TABLE1` set c1=10, c2=20, c4=40');
    AuditDataLayer::$dl->executeNone('delete from `TABLE1`');
    ...
    $rows = AuditDataLayer::$dl->executeRows(sprintf('select * from `%s`.`TABLE1`', self::$auditSchema));
